...
set :repo_url, 'git@github.com:aqfaridi/aws-ec2-deploy.git'
set :branch, :master
set :deploy_to, '/home/deploy/blog'
set :pty, true
set :linked_files, %w{config/database.yml config/application.yml config/secrets.yml config/local_env.yml}
